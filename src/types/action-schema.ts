...
/**
 * Data received from Action Center via the loadApp event
 */
export interface ActionCenterData {
  ...
  action: string;
  /** UiPath Orchestrator folder ID where the task resides */
  organizationUnitId: number;
  /** Full path of the Orchestrator folder (e.g., "Shared/Finance/Approvals") */
  organizationUnitFullyQualifiedName: string;
  /** UiPath Cloud/Orchestrator base URL */
  baseUrl: string;
  /** Organization name in UiPath Cloud */
  orgName: string;
  /** Tenant name in UiPath Orchestrator */
  tenantName: string;
  /** Authentication token for API calls */
  token: string;
  language: string;
  theme: Theme;
  /** Refreshed token (sent when token is about to expire) */
  newToken?: string;
  newLanguage?: string;
  newTheme?: string;
}
